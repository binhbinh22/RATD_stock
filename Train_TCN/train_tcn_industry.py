...
results_file = "tcn_industry_results_AMZN_9624.csv"
                ...
                for batch_size in param_grid['batch_size']:
                    for lr in param_grid['learning_rate']:
                        ...
                        if best_val_loss < best_overall_val_loss:
                            ...
                            best_model = model
                            torch.save(model.state_dict(), "results/tcn_industry_best_AMZN_9624.pt")
                            torch.save(model.encoder.state_dict(), "results/tcn_industry_encoder_best_AMZN_9624.pt")
                            
                            with open("results/best_params_industry_AMZN_9624.txt", 'w') as f:
...
print(f"Best model saved to tcn_industry_best.pt")
print(f"Best encoder saved to tcn_industry_encoder_best.pt")