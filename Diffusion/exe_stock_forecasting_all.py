...
from utils_all import train, evaluate
...
parser.add_argument("--csv_path", type=str, default="GOOG.csv")
...
for top_k in top_k_list:
    for step_size in step_size_list:
        reference =  torch.load(f'{stock}_k_n_all/{stock}_vs_all_{top_k}_{step_size}.pt')
